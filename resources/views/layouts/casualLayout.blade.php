            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class=" @if (Route::currentRouteName() == 'casual.profile')
                     active active-menu
                     @endif" ><a class="iq-waves-effect"  href="{{route('casual.profile',$current->id)}}" ><span class="ripple rippleEffect"></span><i class="las la-user-tie "></i><span>Profile</span></a></li>
                        {{--end of employee options  --}}
                           {{-- start payment and leaves options --}}
                     <li class=" @if (Route::currentRouteName() == 'casual.payment')
                     active active-menu
                     @endif"><a class="iq-waves-effect"  href="{{route('casual.payment',$current->id)}}"><i class="las la-tags"></i><span>Payment</span> </a></li>
                        {{--end of payment and leaves  options  --}}
                                {{-- start Transaction options --}}
                     <li class=" @if (Route::currentRouteName() == 'casual.timecard.index')
                     active active-menu
                     @endif"><a class="iq-waves-effect" href="{{route('casual.timecard.index',$current->id)}}"><i class="las la-stopwatch"></i><span>TimeCard</span></a></li>
