                             ...
                             <table id="user-list-table" class="table table-striped table-bordered mt-4" role="grid" aria-describedby="user-list-page-info">
                               <thead>
                                   <tr>
                                      ...
                                      <th class="text-center">Total Transactions Amount</th>
                               ...
                               <tbody>
                                   ...
                                   <tr>
                                      <td class="text-center">{{$employee->fname}} {{$employee->lname}}</td>
                                      ...
                                      <td>
                                         <div class="flex align-items-center list-user-action text-center">
                                            <a class="iq-bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Transactions" href="{{route('transaction.show',$employee->id)}}"><i class="las la-eye"></i></a>
                                         </div>
                                      </td>
                                   </tr>
                                   @endforeach
